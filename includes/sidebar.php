...
$dashLink = ($role === 'admin') ? 'admin.php' : 'user.php'; // Mengarah ke /admin atau /user
?>
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="books.php" class="nav-item-custom <?= ($currentPage === 'books.php') ? 'active' : '' ?>">
            <i class="bi bi-journal-bookmark"></i> Daftar Buku
        </a>
        
        <?php if ($role === 'admin'): ?>
        <a href="add_book.php" class="nav-item-custom <?= ($currentPage === 'add_book.php') ? 'active' : '' ?>">
